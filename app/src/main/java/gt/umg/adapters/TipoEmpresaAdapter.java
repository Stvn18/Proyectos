 ...
 */
public class TipoEmpresaAdapter extends BaseAdapter {

    private List<TipoEmpresaDTO> lst;
    private Context c;

    public TipoEmpresaAdapter(Context c, List<TipoEmpresaDTO> lst) {
        this.c = c;
        this.lst = lst;
    }
