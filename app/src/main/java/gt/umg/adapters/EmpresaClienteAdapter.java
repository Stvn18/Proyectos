 ...
 */
public class EmpresaClienteAdapter extends BaseAdapter {

    private List<EmpresaClienteDTO> lst;
    private Context c;

    public EmpresaClienteAdapter(Context c, List<EmpresaClienteDTO> lst) {
        this.c = c;
        this.lst = lst;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        EmpresaClienteDTO t = lst.get(position);
